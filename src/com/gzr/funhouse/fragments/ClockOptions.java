...
public class ClockOptions extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Indexable {
    ...
    private static final String PREF_STATUSBAR_CLOCK_SECONDS = "statusbar_clock_seconds";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mClockPosition.setValue(Integer.toString(Settings.Secure.getInt(getActivity()
                .getContentResolver(), Settings.Secure.STATUSBAR_CLOCK_POSITION,
                0)));
        ...
        mStatusBarClock.setChecked((Settings.Secure.getInt(
                ...
                Settings.Secure.STATUS_BAR_CLOCK, 0) == 0));
        mStatusBarClock.setOnPreferenceChangeListener(this);

        mStatusBarClockSeconds = (SwitchPreference) findPreference(PREF_STATUSBAR_CLOCK_SECONDS);
        mStatusBarClockSeconds.setChecked((Settings.Secure.getInt(
                getActivity().getApplicationContext().getContentResolver(),
                Settings.Secure.STATUSBAR_CLOCK_SECONDS, 0) == 1));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_CLOCK_POSITION, val);
